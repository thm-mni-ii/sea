...
TEST(EulerTrailTest, hierholzerTrail) {
    ...
    adj_mtrx[0] = new uint64_t[order]{0, 1, 0, 1, 1, 1};
    adj_mtrx[1] = new uint64_t[order]{1, 0, 1, 0, 0, 0};
    adj_mtrx[2] = new uint64_t[order]{0, 1, 0, 1, 0, 0};
    adj_mtrx[3] = new uint64_t[order]{1, 0, 1, 0, 0, 0};
    adj_mtrx[4] = new uint64_t[order]{1, 0, 0, 0, 0, 0};
    adj_mtrx[5] = new uint64_t[order]{1, 0, 0, 0, 0, 0};
