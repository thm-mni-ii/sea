...
template <typename BlockType, typename AllocatorType>
bool Bitset<BlockType, AllocatorType>::operator[](uint64_t bit) const {
    return get(bit);
}
...
template <typename BlockType, typename AllocatorType>
const BlockType &Bitset<BlockType, AllocatorType>::getBlock(
    uint64_t idx) const {
...
template <typename BlockType, typename AllocatorType>
Bitset<BlockType, AllocatorType> &Bitset<BlockType, AllocatorType>::operator&=(
    const Bitset<BlockType, AllocatorType> &rhs) {
...
template <typename BlockType, typename AllocatorType>
BlockType Sealib::Bitset<BlockType, AllocatorType>::getShiftedBlock(
    uint64_t idx) const {
...
template class Bitset<uint64_t, std::allocator<uint64_t>>;
template class Bitset<uint32_t, std::allocator<uint32_t>>;
template class Bitset<uint16_t, std::allocator<uint16_t>>;
template class Bitset<uint8_t, std::allocator<uint8_t>>;
}  // namespace Sealib
