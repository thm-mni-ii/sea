#ifndef SEALIB_RANKSELECT_RANKSELECT_H_
#define SEALIB_RANKSELECT_RANKSELECT_H_

#include <sealib/rankselect/rankstructure.h>
...
#endif  // SEALIB_RANKSELECT_RANKSELECT_H_
