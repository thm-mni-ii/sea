...
class GraphIO {
 public:
     ...
     */
    static std::string stringFromTrail(const Sealib::Graph &g, Sealib::TrailStructure **trail);
     ...
     */
    static void dotFileFromTrail(const Sealib::Graph &g, Sealib::TrailStructure **trail, std::string fileName);
     ...
     * @param fileName name of the file to write to
     */
    static void dotFileFromGraph(const Sealib::Graph &g, std::string fileName);
     ...
     */
    static void ogdfGraphFromSealibGraph(const Sealib::Graph &sealibGraph, ogdf::Graph &ogdfGraph);
     ...
     * @return trail as string
     */
    static void graphAttributesFromTrail(ogdf::GraphAttributes &GA, const Sealib::Graph &g, Sealib::TrailStructure **trail);
     ...
     * @return Sealib::Graph
     */
    static void sealibGraphFromOgdfGraph(const ogdf::Graph &ogdfGraph, Sealib::Graph &sealibGraph);
     ...
     * @return ogdf::Graph
     */
    static void randomEulerianOgdfGraph(int nodeMax, int edgeMax, ogdf::Graph &g);
    ...
    * @return Sealib::Graph
    */
    static void randomEulerianSealibGraph(int nodeMax, int , Sealib::Graph &g);

    void randomEulerianOgdfGraph(int nodeMax, int edgeMax, Graph &g);
};
}  // namespace Sealib
#endif  // SEA_GRAPHIO_H